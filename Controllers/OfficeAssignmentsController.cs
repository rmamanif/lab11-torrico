...
using UniversityL11;
using UniversityL11.Models;

namespace UniversityL11.Controllers
{
    public class OfficeAssignmentsController : Controller
    {
        ...
        {
            var officeAssignments = db.OfficeAssignments.Include(o => o.Instructor).Where(o => o.IsActive == true);
        ...
        public ActionResult Create([Bind(Include = "InstructorID,Location,IsActive")] OfficeAssignment officeAssignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InstructorID,Location,IsActive")] OfficeAssignment officeAssignment)
        {
            if (ModelState.IsValid)
            {
